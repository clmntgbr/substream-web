...
import { VideoQueueColumnHeader } from "./video-queue-column-header";
import { VideoQueueRowActions } from "./video-queue-row-actions";
...
export const getColumns = (t: Translations, lang?: string): ColumnDef<Stream>[] => [
  ...
  },
  {
    ...
    header: ({ column }) => <VideoQueueColumnHeader column={column} title={t.home.queue.columns.originalFileName as string} />,
    cell: ({ row }) => {
      return (
        <HoverCard>
  ...
  {
    accessorKey: "status",
    header: ({ column }) => <VideoQueueColumnHeader column={column} title={t.home.queue.columns.status as string} />,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => <VideoQueueColumnHeader column={column} title={t.home.queue.columns.progress as string} />,
    cell: ({ row }) => {
      const stream = row.original;
  ...
  },
  {
    id: "size",
    accessorKey: "size",
    header: ({ column }) => <VideoQueueColumnHeader column={column} title={t.home.queue.columns.sizeInMegabytes as string} />,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => <VideoQueueColumnHeader column={column} title={t.home.queue.columns.createdAt as string} />,
    cell: ({ row }) => {
  ...
  {
    id: "actions",
    cell: ({ row }) => <VideoQueueRowActions row={row} />,
  },
];
