                          ...
                          <FieldLabel htmlFor="arial">
                            <Field orientation="horizontal">
                              <FieldContent>
                                ...
                                <FieldDescription>
                                  {t.home.preview.settings.arialDescription}
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem
                                value="Arial"
                  ...
                  <FieldGroup>
                    <Field>
                      <NumberInput
                        ...
                        description={
                          t.home.preview.settings.outlineThicknessDescription
                        }
                        unit="px"
                        disabled={readOnly}
                      />
                  ...
                  <FieldGroup>
                          ...
                          <FieldLabel htmlFor="original">
                            <Field orientation="horizontal">
                              <FieldContent>
                                ...
                                <FieldDescription>
                                  {t.home.preview.settings.originalDescription}
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem
                                value="original"
                    ...
                    <Field>
                      <NumberInput
                        ...
                        step={1}
                        description={
                          t.home.preview.settings.yAxisAlignmentDescription
                        }
                          ...
                          <Field orientation="horizontal">
                            <FieldContent>
                              <FieldLabel htmlFor="isResume">
                                {t.home.preview.settings.isResume}
                              </FieldLabel>
                              <FieldDescription>
                                {t.home.preview.settings.isResumeDescription}
                              </FieldDescription>
                            </FieldContent>
                            <Switch
                              id="isResume"
                        ...
                        >
                          <FieldLabel htmlFor="auto">
                            <Field orientation="horizontal">
                              <FieldContent>
                                <FieldTitle>
                                  {t.home.preview.settings.auto}
                                </FieldTitle>
                                <FieldDescription>
                                  {t.home.preview.settings.autoDescription}
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem
                                value="auto"
                          ...
                          <FieldLabel htmlFor="english">
                            <Field orientation="horizontal">
                              <FieldContent>
                                <FieldTitle>
                                  {t.home.preview.settings.english}
                                </FieldTitle>
                                <FieldDescription>
                                  {t.home.preview.settings.englishDescription}
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem
                                value="english"
                          ...
                          <FieldLabel htmlFor="french">
                            <Field orientation="horizontal">
                              <FieldContent>
                                <FieldTitle>
                                  {t.home.preview.settings.french}
                                </FieldTitle>
                                <FieldDescription>
                                  {t.home.preview.settings.frenchDescription}
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem
                                value="french"
