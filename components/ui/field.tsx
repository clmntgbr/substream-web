...
const fieldVariants = cva(
  "group/field flex w-full gap-3 data-[invalid=true]:text-destructive has-[[data-slot=radio-group-item]:disabled]:cursor-not-allowed has-[[data-slot=checkbox-item]:disabled]:cursor-not-allowed",
  {
    variants: {
      orientation: {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "has-[[data-slot=radio-group-item]:disabled]:cursor-not-allowed has-[[data-slot=checkbox-item]:disabled]:cursor-not-allowed",
        className
      )}
      {...props}
    />
