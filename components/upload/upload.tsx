...
export const Upload = () => {
  ...
  return (
    <div className="w-full h-[80vh] rounded-xl">
      <div
        className={`relative h-full flex items-center border-2 border-dashed rounded-xl`}
      >
        <div className="w-full p-12 text-center">
          ...
          >
            <CloudUploadIcon
              size={32}
              className={`transition-colors duration-300 ${isDragOver ? "text-primary" : "text-muted-foreground"}`}
            />
          </div>
